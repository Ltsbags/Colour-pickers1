...
export const metadata: Metadata = {
  ...
  description: 'Explore our full suite of professional color tools: HEX converters, gradient generator, color palette suite, eyedropper color picker, and random color discovery.',
};

export default function ToolsDirectoryPage() {
  const tools = [
    {
      title: 'All-in-One Color Converter',
      href: '/tools/converter',
      icon: ArrowRightLeft,
      color: 'bg-blue-500',
      description: 'Convert color codes effortlessly between HEX, RGB, HSL, HSV, and CMYK formats in real-time.',
    },
    {
      ...
      icon: Sliders,
      color: 'bg-indigo-500',
      description: 'Convert HEX color codes to RGB values and vice versa with precision component controls.',
    },
    {
      title: 'HEX ⇄ HSL Converter',
      href: '/tools/hex-to-hsl',
      icon: Sliders,
      color: 'bg-emerald-500',
      description: 'Transform HEX codes into Hue, Saturation, and Lightness representation.',
    },
    {
      title: 'HEX ⇄ HSV Converter',
    ...
    },
    {
      ...
      icon: Pipette,
      color: 'bg-rose-500',
      description: 'Pick colors directly from your desktop screen using the Eyedropper API and fine-tune with color wheels.',
    },
    {
