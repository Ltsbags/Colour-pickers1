...
export const metadata: Metadata = {
  ...
  description:
    'Convert HEX color codes to HSL (Hue, Saturation, Lightness) format with interactive preview, CSS code output, and mathematical step-by-step formulas.',
  alternates: {
  ...
  openGraph: {
    ...
    description:
      'Convert HEX color codes to HSL (Hue, Saturation, Lightness) format with interactive preview.',
