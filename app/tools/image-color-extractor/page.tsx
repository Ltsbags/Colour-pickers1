        ...
        <article className="my-16 space-y-12 max-w-4xl mx-auto">
          ...
          <section className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800/80 rounded-3xl p-6 sm:p-10 shadow-xs space-y-4">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
              The <strong>Image Color Extractor</strong> is a high-precision, client-side digital tool that analyzes photos, brand graphics, illustrations, and design mockups to automatically detect the primary color palette. Whether you need to reverse-engineer a photograph’s mood, build a brand style guide from a company logo, or create matching CSS variables for a website background, this tool instantly breaks down any visual asset into distinct, actionable color specifications.
            </p>
            <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
